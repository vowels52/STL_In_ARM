...
Reset_Handler 	PROC
				...
				LDR        	r0, =__initial_sp    ; load initial MSP
                MSR        	MSP, r0
				...
				LDR        	r0, =__initial_user_sp ; load initial PSP
                MSR        	PSP, R0
				
				MRS        	r1, CONTROL
                ORR        	r1, r1, #0x3        ; switch to unpriviledged thread mode
                MSR        	CONTROL, r1
